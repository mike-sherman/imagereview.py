...
#
# Copyright (c) 2019-2020 Michael Sherman. All rights reserved.
#
# LICENSE: LGPL
# 
...
# --------------------------------------------------
#
#  required to be filled in below:
#   "/path/to/imagereview.ui"           - where the imagereview.ui file is located
#   base_dir = '/path/to/images/'       - where the folders of images are located
...
Ui_MainWindow, QtBaseClass = uic.loadUiType("/path/to/imagereview.ui")
...
class MyApp(QMainWindow, Ui_MainWindow):
    ...
    prog_dir = '/path/to/imagereview/'
    # the name of the log file
    log_file = prog_dir + "data.json"
